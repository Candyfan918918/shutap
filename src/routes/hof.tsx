      ...
      <main className="mx-auto max-w-[480px] md:max-w-[640px] lg:max-w-3xl border-x border-c-surface-3 bg-c-surface">
        ...
        {shockingCourt ? (
          <CourtVerdictCard
            ...
            bars={[{ w: 94, c: "#f09595" }, { w: 4, c: "var(--c-pink-soft)" }, { w: 2, c: "var(--c-amber-soft)" }]}
        ...
        {mostDramatic && (
          <CourtVerdictCard
            ...
            bars={[{ w: 71, c: "#f09595" }, { w: 22, c: "var(--c-amber-soft)" }, { w: 7, c: "var(--c-surface-3)" }]}
          />
        )}
        {mostSurprising && (
          <CourtVerdictCard
            ...
            bars={[{ w: 78, c: "#f09595" }, { w: 14, c: "var(--c-teal-soft)" }, { w: 8, c: "var(--c-surface-3)" }]}
            ...
            footer={
              <div className="mt-2 text-[11px] text-c-purple-deep flex items-center gap-1.5">
                <span>🧠</span> Prediction score impact: 78% of predictors lost points. 22% who said reconcile gained.
              </div>
            }
          />
        )}
